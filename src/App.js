    ...
    <Router>
      ...
      <nav className="navbar navbar-expand-lg navbar-light bg-light">
          <ul className="navbar-nav mr-auto">
            <li><Link to={'/'} className="nav-link"> CompetetionDetails </Link></li>
            <li><Link to={'/PanellistsInfo'} className="nav-link">PanellistsInfo</Link></li>
            <li><Link to={'/Platform'} className="nav-link">Platform</Link></li>
            <li><Link to={'/Prizes'} className="nav-link">Prizes</Link></li>
            <li><Link to={'/RegistrationInfo'} className="nav-link">RegistrationInfo</Link></li>
            <li><Link to={'/Spnsors'} className="nav-link">Spnsors</Link></li>
      ...
      <div>
        ...
        <Routes>
          ...
          <Route exact path="/RegistrationInfo" element={<RegistrationInfo/>}/>
